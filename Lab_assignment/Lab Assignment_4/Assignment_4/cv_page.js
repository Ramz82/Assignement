...
<Image
      ...
      <View style={styles.rightbar}>
                ...
                <Text style={styles.rightbarh2}>+92-{phoneNumber}</Text>
                <Text style={styles.rightbarh3}>www.{name}_portfolio.com</Text>
                <Text style={styles.rightbarh4}>{email} </Text>
            ...
            <Text style={styles.heading}>SSC  ( {(schoolPassingYear-2)}-{schoolPassingYear})</Text>
            <Text style={{fontSize:5,marginTop:2,lineHeight:7}}>I have done my
            ssc from {schoolName}</Text>
            <Text style={styles.heading}>HSSC ( {schoolPassingYear} - {collegePassingYear} )</Text>
            <Text style={{fontSize:5,marginTop:2,lineHeight:7}}>I have done my HSSC from {collegeName}
            </Text>
            <Text style={styles.heading}>{Degreetitle} ({collegePassingYear} - {universityPassingYear} )</Text>
            <Text style={{fontSize:5,marginTop:2,lineHeight:7}}>{unistatus == 1
          ? `I am currently studying ${Degreetitle} at ${universityName}`
          : `I have done my graduation from ${universityName}`} </Text>
            </View>
